 ...
 */
public class MenuManager_focus_menuJsonFile {

	private static Logger log = Logger.getLogger(MenuManager_focus_menuJsonFile.class);
	...
	String TrueCfg=	Constant.path + "WeiXinConfig.properties";
		...
		if (accessToken != null) {
			...
			String menu = pathx.webAppPath()+File.separator+ "menu_focus.json";
			String menu_txt=com.attilax.io.filex.read(menu);
			core.log(menu);
