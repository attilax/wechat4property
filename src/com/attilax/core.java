...
import org.logicalcobwebs.cglib.proxy.NoOp;
...
public class core {
	...
	// attilax 老哇的爪子     下午3:52:15 2014-6-25
	...
	new com.attilax.tryX<String>() {
		...
		// attilax 老哇的爪子     下午4:26:49 2014-6-25
	...
	new com.attilax.tryX<String>() {		@Override		 		public String $$(Object t) throws Exception {
	 // attilax 老哇的爪子     下午4:27:12 2014-6-25
	...
	/**	 * 	@author attilax 老哇的爪子
		@since  2014-7-2 上午2:15:36$	
	 * @param request
	 * @param obj
	 * @return
	 */
	public static void debugReq(HttpServletRequest request) {
	 ...
	 * @return
	 */
	public static <atitype> atitype request2obj(HttpServletRequest request, final atitype obj) {
	// todox Apache的BeanUtils的使用入门 enhance effice
	Map parameterMap = request.getParameterMap();
	...
	return new tryX<atitype>() {
		...
		@Override public atitype item(Object t) throws Exception {
...
//	}
	 ...
	 * @param mtr
	 */
	@Deprecated // @Conditional(displayType="jeig b suppt type auto vonvert ..should use beans .cpy")
